...
function setup() {
    ...
    character2 = new Character(100,100);
    character.addAnimation("right",new SpriteAnimation(green,1,0,8));
    character.addAnimation("left",new SpriteAnimation(green,1,0,8));
