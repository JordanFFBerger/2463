...
function setup() {
    ...
    character3.addAnimation("right",new SpriteAnimation(green,1,0,8));
    character3.addAnimation("left",new SpriteAnimation(green,1,0,8));
    character3.addAnimation("stand", new SpriteAnimation(green,0,0,1));
