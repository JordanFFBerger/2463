function setup() {
  ...
  function mouseclicked() {
    ...
    let blue;
    let green;
    if(mouseX >= 0 && mouseX <= 20 && pmouseY <= 240){
        red = red(mouseX,mouseY);
        
        blue = blue(mouseX,mouseY);
        green = green(mouseX,pmouseY);
        console.log("Red is " + red);

    }
    red = red(pmouseX,p);
        
        blue = blue(pmouseX,pmouseY);
        green = green(pmouseX,pmouseY);
        console.log("Red is " + red);
