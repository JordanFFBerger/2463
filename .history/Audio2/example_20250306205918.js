...
function draw() {
    background(220);
    text("Vibrato Frequency " + frequencySlider.value(), 15,90);
    text("Vibrato Depth: " + depthSlider.value(), 205, 90);
}
