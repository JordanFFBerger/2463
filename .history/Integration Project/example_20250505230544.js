...
function preload(){
    ...
    buffer1 = loadSound( "media/drum/000_drum1.wav");
    buffer2 = loadSound("media/drum/001_drum2.wav");
    buffer3 = loadSound("media/drum/002_drum3.wav");
    buffer4 = loadSound("A4": "media/drum/003_drum4.wav")
}
function setup() {
    ...
    let Music3 = new Tone.Sampler({
        

        
           "C4": "media/drum/000_drum1.wav",
           "D#4": "media/drum/001_drum2.wav",
           "F#4": "media/drum/002_drum3.wav",
            "A4": "media/drum/003_drum4.wav",
    ...
    pattern = new Tone.Pattern((time, note) => {
        Music3.triggerAttackRelease(note,0.2, time);
    }, ["C4", ["F#4", "D#4", "F#4"], ["F#4", "A4", "F#4"], ], "upDown").start(0);
