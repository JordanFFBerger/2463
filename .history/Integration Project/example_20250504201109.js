...
function setup() {
    ...
    obstacle1 = new Obstacle(300, groundY+10);
    obstacle1.addAnimation("X", new SpriteAnimation(obby,0,0,0));
    obstacle1.addAnimation("XX", new SpriteAnimation(obby,0,0,1))
    obstacle1.addAnimation("O", new SpriteAnimation(obby,2,0,5));
...
function obstaclePlacement() {
    ...
    nextObstacle = new Obstacle(300, groundY-20);
    nextObstacle.addAnimation("X", new SpriteAnimation(obby,0,0,0));
    nextObstacle.addAnimation("XX", new SpriteAnimation(obby, 0, 0, 1));
    nextObstacle.addAnimation("O", new SpriteAnimation(obby,2,0, 5));

    if(getRandomInt() % 2 == 0)
    {
        if(miles > 15)
        {
            nextObstacle.currentAnimation = "XX";
        }
        else{
