...
function setup() {
    ...
    obstacle1.addAnimation("X", new SpriteAnimation(obby,0,0,5));
    obstacle1.addAnimation("O", new SpriteAnimation(obby,1,0,5));
...
class Hero {
    ...
    keyPressed(){
        if (keyCode == 32)
        {
            console.write("spacebar pressed")
